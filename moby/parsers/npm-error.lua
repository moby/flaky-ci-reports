...
--   npm error code <CODE>
-- and then exits non-zero. The error code identifies the failure mode
-- (ECONNRESET, ENOENT, E404, ...). The downstream
-- `##[error]Unhandled error: Error: The process '/usr/local/bin/npm' failed
-- with exit code N` wrapper is just exit-code noise and isn't keyed on.
