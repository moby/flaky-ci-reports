...
--
-- This parser only matches the `process "<cmd>" did not complete
-- successfully:` shape. Other `buildx bake failed with:` umbrellas
-- (oauth token failures, resolve source metadata, etc.) are caught by
-- registry-error / registry-net-error / docker-resolve-source-failed.
