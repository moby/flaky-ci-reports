...
-- action tarball from api.github.com and the HTTP request keeps coming
-- back non-2xx. Retried with backoff; eventually fails with
--   ##[warning]Failed to download action 'https://api.github.com/repos/<owner>/<repo>/tarball/<sha>'. Error: Response status code does not indicate success: <CODE> (<reason>). <id>
...
-- action URL host is always api.github.com so it's not in the key.
--
